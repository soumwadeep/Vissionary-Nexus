      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Vissionary Nexus</span>
            </Link>
            <p className="text-muted-foreground text-sm mb-6 max-w-xs">
              An autonomous AI-powered innovation ecosystem for hackathons, startups, and collaboration.
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">Stay updated with the latest innovations</p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-border/50">
          <p className="text-sm text-muted-foreground">
            2024 Vissionary Nexus. All rights reserved.
          </p>
