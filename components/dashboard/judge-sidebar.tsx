...
const menuItems = [
  // { icon: Home, label: "Home", href: "/dashboard/judge" },
  ...
  { icon: BarChart3, label: "AI Insights", href: "/dashboard/judge/insights" },
  { icon: Trophy, label: "Rankings", href: "/dashboard/judge/rankings" },
  { icon: Settings, label: "Settings", href: "/dashboard/judge/settings" },
]
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            {!collapsed && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                ...
                <span className="text-xs text-orange-400 block">Judge Portal</span>
              </motion.div>
            )}
          </Link>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-sidebar-accent text-orange-400 border border-orange-400/30"
                    : "text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground"
                )}
              >
                <item.icon className={cn("w-5 h-5 shrink-0", isActive && "text-orange-400")} />
